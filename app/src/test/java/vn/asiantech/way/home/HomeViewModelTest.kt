...
class HomeViewModelTest {
    ...
    fun `Given a list tracking history - When get tracking history - Then return list tracking history`() {
        /* Given */
        val trackingHistories = mutableListOf(TrackingInformation("2016-03-09T05:20:19.742229", "Tracking", "xxxx", LatLng(423.0, 12.0)),
                TrackingInformation("2016-03-09T05:20:19.742229", "Stop", "xxxx", LatLng(32.0, 14.0)))
        val test = TestObserver<DiffUtil.DiffResult>()
        `when`(localRepository.getTrackingHistory()).thenReturn(trackingHistories)
    ...
    @Test
    fun `Given a new list tracking history and old list tracking history not null - When get tracking history - Then return list tracking history`() {
        /* Given */
