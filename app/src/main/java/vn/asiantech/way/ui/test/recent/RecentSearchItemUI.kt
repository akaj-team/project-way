...
class RecentSearchItemUI : AnkoComponent<ViewGroup> {
    ...
    internal lateinit var imgRecentIcon: RoundedImageView
    internal lateinit var tvRecentName: TextView
    internal lateinit var tvRecentDescription: TextView
    ...
    override fun createView(ui: AnkoContext<ViewGroup>) = with(ui) {
        linearLayout {
            ...
            imgRecentIcon = roundedImage(ctx) {
